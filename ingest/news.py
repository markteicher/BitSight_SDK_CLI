...
# BitSight News endpoint
BITSIGHT_NEWS_ENDPOINT = "/ratings/v1/news"
...
def fetch_news(
    ...
    url = f"{base_url}{BITSIGHT_NEWS_ENDPOINT}"
    ...
    while True:
        ...
        for obj in results:
            records.append(_normalize_news(obj, ingested_at))
