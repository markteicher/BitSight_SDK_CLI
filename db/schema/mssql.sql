...
---------------------------------------------------------------
-- DOCUMENTED BITSIGHT API ENDPOINT COVERAGE
-- Source scope: current public Bitsight API documentation.
-- Storage is response-oriented; write operations are additionally
-- captured by dbo.bitsight_api_requests.
---------------------------------------------------------------
